...
Event ID 14: Credential Guard configuration. The first variable indicates if Credential Guard is configured to run, and the second variable indicates if it's configured to run in protect mode or test mode.
