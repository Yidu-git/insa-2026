...
```
![[INSA-CHALLENGE-2026-5-9-NMAP_Results.png]]
...
```
![[INSA-CHALLENGE-2026-5-9-FFUF_Results.png]]
#### Open endpoints:
...
- **Support** - *302* - Support page
![[INSA-CHALLENGE-2026-5-9-FFUF_Results_2.png]]
...
![[INSA-CHALLENGE-2026-5-9-Endpoint_exploration_1.png]]
`FLAG{Fu33ing_Wins}`
...
![[INSA-CHALLENGE-2026-5-9-Broken_access_control_flag.png]]
...
![[INSA-CHALLENGE-2026-5-9-Horizontoal_flag.png]]
...
![[INSA-CHALLENGE-2026-5-9-Vertical_flag.png]]
...
![[INSA-CHALLENGE-2026-5-9-FINAL_flag.png]]