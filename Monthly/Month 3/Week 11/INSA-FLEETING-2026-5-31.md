...
## JADX
---
JADX is a tool used to analyze and decompile android applications (`.apk`s). It is usually paired with an android emulator (ex; GenY Motion) to test for vulnerabilities in applications.
